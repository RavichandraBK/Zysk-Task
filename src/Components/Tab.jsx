    ...
    <>
      <div>
        <div className="flex flex-col items-center ">
          <div className="border-2 border-[#E9D7FE] rounded-2xl flex bg-[#F9F5FF]  w-full justify-around items-center h-8 sm:w-3/12">
            ...
            <p className="text-center text-[#6941C6] text-sm">
              Check out the team dashboard &#x2794;
            </p>
          </div>
          <p className="text-center text-[36px] sm:text-[60px] font-bold leading-[44px] sm:leading-[72px] mt-5">
            Beautiful analytics to grow smarter
          </p>
          <p className="text-center text-[#475467] text-[18px] sm:text-[20px] leading-[28px] sm:leading-[30px] text-md w-11/12 sm:w-6/12 mt-3">
            Powerful, self-serve product and growth analytics to help you
            convert, engage, and retain more users. Trusted by over 4,000
            startups.
          </p>
          <div className="flex  flex-col md:flex-row gap-4 md:justify-center mt-3 md:gap-5 w-5/6">
            <button className="text-center w-full  h-14 bg-[#7F56D9] sm:h-10 rounded-md text-white  border md:w-20  md:order-2">
              Sign up
            </button>
            <button className="text-center w-full h-14 border sm:w-20  sm:h-10 md:order-1">
              Demo
            </button>
          </div>
        </div>
        ...
        <div>
          <p className="text-[#475467] text-center leading-[24px] mt-16">
          ...
          <div className="flex flex-wrap justify-around sm:flex-nowrap w-full sm:mt-10 mt-5">
            <img
              src={boltshift}
              alt=""
              className="w-[150px] mt-5 sm:w-auto sm:mt-auto"
            />
            <img
              src={lightbox}
              alt=""
